...
_RUBRIK = (
    ...
    "  5=Initiates, maintains, and ends discourse naturally; turns flow effortlessly; responds to all nuances.\n"
    "  4=Participates actively; picks up cues; repairs breakdowns effectively; elaborates without prompting.\n"
    "  3=Keeps conversation going; manages straightforward exchanges with ease; occasional prompting needed.\n"
    "  2=Communicates in simple predictable exchanges; relies on support from interlocutor.\n"
    "  1=Very limited interaction; relies on question-answer format; minimal elaboration.\n\n"
    "TOTAL = (Range+Accuracy+Fluency+Coherence+Interaction)/5\n"
    ...
    "ANCHOR A — Slow, hesitant, simple vocabulary, minimal responses:\n"
    "  'I am... uh... working in the, uh, company. It is good place. I like it very much.'\n"
    "  WPM≈40 | Range=2, Accuracy=2, Fluency=1, Coherence=2, Interaction=1\n\n"
    "ANCHOR B — Fluent delivery but limited vocabulary, responds but does not elaborate:\n"
    ...
    "  WPM≈130 | Range=2, Accuracy=3, Fluency=4, Coherence=2, Interaction=3\n\n"
    "ANCHOR C — Rich vocabulary and coherent, engages substantively but some hesitation:\n"
    ...
    "  WPM≈95 | Range=4, Accuracy=4, Fluency=3, Coherence=4, Interaction=4\n\n"
    "ANCHOR D — Near-native: varied vocabulary, accurate grammar, fluent, fully engages:\n"
    ...
    "  WPM≈155 | Range=5, Accuracy=5, Fluency=5, Coherence=5, Interaction=5\n\n"
    "=== PROCEDURE ===\n"
